export interface UserInfoClaims {
   ...
   * `given_name`. For instance, a `nickname` value of _Mike_ might be returned
   * alongside a `given_name` value of _Michael_.
   */
  nickname?: string;

  /**
   * Shorthand name by which the End-User wishes to be referred to at the RP,
   * such as _janedoe_ or _j.doe_. This value **MAY** be any valid JSON string
   * including special characters such as `@`, `/`, or whitespace. The RP **MUST
   * NOT** rely upon this value being unique, as discussed in [Section
   ...
   * 5322](https://www.rfc-editor.org/rfc/rfc5322.html) addr-spec syntax. The RP
   * **MUST NOT** rely upon this value being unique, as discussed in [Section
   * 5.7](https://openid.net/specs/openid-connect-core-1_0.html#ClaimStability).
   */
  email?: string;
  ...
  /**
   * End-User's birthday, represented as an [ISO
  ...
  /**
   * End-User's locale, represented as a BCP47 [RFC
   ...
   * the `phone_number` Claim **MUST** be in
